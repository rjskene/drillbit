...
from bitcoin.statements.funcs import cooling_energy, expected_difficulty, hashes_to_hash_rate, win_percentage, miner_amort, amort_sched
from envirosim.statements import MineTemplate as PoolTemplate, MineStats as PoolStats
